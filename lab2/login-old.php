  ...
  <section class="body">
    <div class="row">
      ...
      <p>
        ...
        <h2>Znanje i vještine</h2>
        <p>

        jezici: engleski jezik, njemački jezik</p>
        ...
        <p>
          Vješto korištenje alata u MS Office-u – znanje stečeno u osnovnoj i srednjoj školi (Informatika), te na fakultetu na kolegiju “Primjena računala”
